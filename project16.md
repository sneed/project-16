...
![aws s3](images/aws-s3bucket.png)
...
````
![boto3](images/python-s3bucket.png)
...
- [Local Values](https://developer.hashicorp.com/terraform/docs/glossary#data-source)
...
![terafform.tfvars](images/terraform-tfsvars.png)

![tree](images/tree.png)

![terraform plan](images/terraform-plan.png)

![terraform apply1](images/terraformapply1.png)

![terraform apply2](images/terraform-apply2.png)

![terraform apply3](images/terraform-apply3.png)

![VPC](images/terraform-vpc.png)

![Subnets](images/subnets-terraform.png)
